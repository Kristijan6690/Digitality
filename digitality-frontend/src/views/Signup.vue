          ...
          <div class="col-sm"></div>
            <div class="col-sm">
              ...
              <div class="nameSurname">
                  ...
                  <input type="text" v-model="name" class="form-control placeholderEmail" aria-describedby="emailHelp" placeholder=" ime i prezime..."  />
              </div>
              <div class="email">
              ...
              <div class="password">
                  ...
                  <input type="password" v-model="confimpassword" class="form-control"   placeholder="ponovi lozinku..."  />
